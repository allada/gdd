...
func (c *ReadCommand) Initalize(targetId string, responseId int64, conn *shared.Connection) {
...
func (c *CloseCommand) Initalize(targetId string, responseId int64, conn *shared.Connection) {
    c.DestinationTargetID = targetId
    c.responseId = responseId
    c.conn = conn
}
